...
function Offers(containerId, data) {
    let cardHtmlData = "";
    data.forEach((d) => {
        cardHtmlData += `
...
function TrendingDestinations(containerId, data) {
    let cardHtmlData = "";
...
function QuickAndEasyTripPlanner(containerId, data) {
    let cardHtmlData = "";
    data.forEach((d) => {
        cardHtmlData += `
        <div class="swiper-slide">
...
function DealsOfWeekend(containerId, data) {
    let cardHtmlData = "";
    data.forEach((d) => {
        cardHtmlData += `
        <div class="swiper-slide">
...
function TopUniqueProperties(containerId, data) {
    let cardHtmlData = "";
    data.forEach((d) => {
        cardHtmlData += `
        <div class="swiper-slide">
